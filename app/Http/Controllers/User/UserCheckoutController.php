...
class UserCheckoutController extends Controller
{
    public function checkout(ExtendRequest $request)
    {
        ...
        if ($request->price == 0) {
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Yoco");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Xendit");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Perfect Money");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Midtrans");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Myfatoorah");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Toyyibpay");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if ($be->base_currency_text != $paytabInfo['currency']) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Paytabs");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for PhonePe");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
            ...
            if (!in_array($be->base_currency_text, $available_currency)) {
                session()->flash('warning', $be->base_currency_text . " is not allowed for Iyzico");
                return back()->withInput($request->all());
            }
            $amount = $request->price;
