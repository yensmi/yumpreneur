(function ($) {
    ...
    $('.chackFeature').on('click', function () {
        ...
        if ($(this).is(':checked')) {
            $.get(mainurl + '/user/product/feature/check/' + featureId + ',1', function (response) {
                if (response == "done") {
                    location.reload();
                }
            })
        } else {
            $.get(mainurl + '/user/product/feature/check/' + featureId + ',0', function (response) {
                if (response == "done") {
                    location.reload();
                }
            })
    ...
    $('.chackSpecial').on('click', function () {
        ...
        if ($(this).is(':checked')) {
            $.get(mainurl + '/user/product/special/check/' + specialId + ',1', function (response) {
                if (response == "done") {
                    location.reload();
                }
            })
        } else {
            $.get(mainurl + '/user/product/special/check/' + specialId + ',0', function (response) {
                if (response == "done") {
                    location.reload();
                }
            })
