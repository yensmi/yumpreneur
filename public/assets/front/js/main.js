...
$(function () {
    ...
    $(document).on('click', '.sliderTab .nav-link', function (e) {
        e.preventDefault();
        $('.sliderTab .nav-link').removeClass('active');
        $(this).addClass('active');
    });
    ...
    $(window).on('load', function () {
        ...
        $('.sliderTab-filter').each(function (index) {
            const swiper = new Swiper(this, {
                ...
                navigation: {
                    nextEl: $(this).closest('.sliderTab-filter-wrap').find('.slider-next')[0],
                    prevEl: $(this).closest('.sliderTab-filter-wrap').find('.slider-prev')[0],
                }
            });
        ...
        // 👇 small delay to let layout finish loading (fix for page reload)
        setTimeout(() => {
        ...
        // 👇 Also refresh swiper every time a tab becomes visible
        $('a[data-toggle="pill"], a[data-bs-toggle="pill"], a[data-bs-toggle="tab"]').on('shown.bs.tab shown.bs.pill', function (e) {
            const targetPane = $($(this).attr('href'));
            const targetSwiper = targetPane.find('.sliderTab-filter')[0];

            if (targetSwiper && targetSwiper.swiper) {
                targetSwiper.swiper.update();
                targetSwiper.swiper.navigation.update();
            }
        });
    });
