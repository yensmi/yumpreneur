                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($template->email_type == 'custom_domain_connected')
                                                            <p class="mb-0">
                                                                <small class="text-secondary">(After Admin connects a custom
                                                                    domain with server & change the status to 'connected'
                                                                    for that domain request)</small>
                                                            </p>
                                                        @endif
                                                        @if ($template->email_type == 'custom_domain_rejected')
                                                            <p class="mb-0">
                                                                <small class="text-secondary">(After Admin change the status
                                                                    to 'rejected' for a custom domain request)</small>
                                                            </p>
                                                        @endif
                                                        @if ($template->email_type == 'registration_with_premium_package')
                                                            <p class="mb-0">
                                                                <small class="text-secondary">(After user registers with a
                                                                    premium package using online payment gateway)</small>
                                                            </p>
                                                        @endif
