            ...
            <div class="col-lg-4">
                 <div class="card">
                         <div class="card-header">
                             <div class="row">
                                 <div class="col-lg-12">
                                     <div class="card-title">{{ __('AWS Credentials') }} {{ '('.__('For Tenants') .')'}}</div>
                                 </div>
                             </div>
                         </div>
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-lg-12">
                                     <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" name="aws_access_key_id" value="{{ $bs->aws_access_key_id }}">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" name="aws_default_region" value="{{ $bs->aws_default_region }}">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" name="aws_bucket" value="{{ $bs->aws_bucket }}">
