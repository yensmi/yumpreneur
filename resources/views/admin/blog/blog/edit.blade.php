            ...
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxForm" class="" action="{{route('admin.blog.update')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="blog_content" data-height="300" placeholder="{{__('Enter content')}}">{{ replaceBaseUrl($blog->content) }}</textarea>
                  <p id="errblog_content" class="mb-0 text-danger em"></p>
                </div>
