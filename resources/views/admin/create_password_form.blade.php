        ...
        <div class="form">
            ...
            @if (session()->has('success'))
                <div class="alert alert-success fade show" role="alert">
                    <strong>{{ __('Success') }}!</strong> {{ session('success') }} <a href="{{ route('admin.login') }}">Login Now</a>
                </div>
            @endif
            ...
            <form class="login-form" action="{{ route('admin.create.password.submit') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="password" class="text-white text-left d-block">{{ __('New Password') }} *</label>
                    <input type="password"class="mb-0" name="password" value="{{ old('password') }}"
                ...
                <div class="form-group">
                    <label for="password_confirmation" class="text-white text-left d-block">{{ __('Confirm Password') }} *</label>
