    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
       <div class="modal-content">
          ...
          <div class="modal-body">
             ...
             <form id="ajaxForm" class="modal-form" action="{{route('admin.gateway.offline.store')}}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <textarea class="form-control summernote" id="instructions" name="instructions" rows="3" cols="80" placeholder="{{__('Enter instructions')}}" data-height="150"></textarea>
                </div>
          ...
          <div class="modal-footer">
             ...
             <button id="submitBtn3" type="button" class="btn btn-primary">{{__('Submit')}}</button>
          </div>
       </div>
    </div>
 </div>
