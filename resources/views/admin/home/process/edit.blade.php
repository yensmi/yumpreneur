              ...
              <div class="col-lg-6 offset-lg-3">
                  ...
                  <div class="form-group">
                      ...
                      <div class="btn-group d-block">
                          <button type="button" class="btn btn-primary iconpicker-component"><i class="{{$process->icon}}"></i></button>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="text" placeholder="Enter Text" value="{{$process->text}}">
                    @if ($errors->has('text'))
