...
@section('content')
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{__('Language')}}</a>
          <a href="#" class="btn btn-primary float-right mr-1" data-toggle="modal" data-target="#addKeywordModal"><i class="fas fa-plus"></i> {{__('keyword')}}</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
                    ...
                    <tbody>
                      @foreach ($languages as $key => $language)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm my-2" href="{{route('admin.language.editKeyword', $language->id)}}">
                            <span class="btn-label">
                              <i class="fas fa-edit"></i>
                            </span>
                            {{__('Edit Keyword')}}
                            </a>
                            <a class="btn btn-secondary my-2 btn-sm" href="{{route('admin.language.edit', $language->id)}}">
                            <span class="btn-label">
                              <i class="fas fa-edit"></i>
                            </span>
                            {{__('Edit')}}
  ...
  @includeif('admin.language.add_keywords')
@endsection
