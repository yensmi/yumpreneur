        ...
        <div class="col-md-12 mx-auto text-center" id="mt">
            <div class="payment mb-30">
                ...
                <div class="content">
                    ...
                    <a href="{{route('user.client.dashboard',getParam())}}" class="btn primary-btn">{{__('Go to Dashboard')}}</a>
                    @else
                    <a href="{{route('user.front.index',getParam())}}" class="btn primary-btn">{{__('Go to Home')}}</a>
                    @endif
                </div>
            </div>
        </div>
