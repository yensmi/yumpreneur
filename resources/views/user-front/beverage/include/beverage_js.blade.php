    ...
    <!-- Counter JS -->
    <script src="{{ asset('assets/restaurant/beverage/assets/js/vendors/jquery.counterup.min.js')}}"></script>
    <!-- Magnific Popup JS -->
    <script src="{{ asset('assets/restaurant/beverage/assets/js/vendors/jquery.magnific-popup.min.js')}}"></script>
    <!-- Swiper Slider JS -->
    <script src="{{ asset('assets/restaurant/beverage/assets/js/vendors/swiper-bundle.min.js')}}"></script>
    <!-- Lazysizes -->
    <script src="{{ asset('assets/restaurant/beverage/assets/js/vendors/lazysizes.min.js')}}"></script>
    <!-- Mouse Hover JS -->
    <script src="{{ asset('assets/restaurant/beverage/assets/js/vendors/mouse-hover-move.js')}}"></script>
    <!-- Twinmax JS -->
    <script src="{{ asset('assets/restaurant/beverage/assets/js/vendors/tweenMax.min.js')}}"></script>
    <!-- AOS JS -->
