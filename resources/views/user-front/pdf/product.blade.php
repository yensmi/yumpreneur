            ...
            <div class="col-lg-6">
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    <td class="bold">{{ $keywords['Serving_Method'] ?? __('Serving Method') }}:
                    </td>
                    <td>
                  ...
                  @endphp
                  <tr>
                    <td class="bold"> {{ $keywords['Cart_Total'] ?? __('Cart Total') }}:</td>
                    <td class="text-capitalize">
                  ...
                  <tr>
                    <td class="bold">{{ $keywords['Shipping_Charge'] ?? __('Shipping Charge') }}:
                    </td>
                    <td class="text-capitalize">
                ...
                <tbody>
                  ...
                  @if ($order->serving_method == 'on_table')
                    @if (!empty($order->table_number))
                      <tr>
                        <td class="bold">
                          {{ $keywords['Table_Number'] ?? __('Table Number') }}:</td>
                        <td>{{ $order->table_number }}</td>
                      </tr>
                    @endif
                    @if (!empty($order->waiter_name))
                      <tr>
                        <td class="bold">{{ $keywords['Waiter_Name'] ?? __('Waiter Name') }}:
                        </td>
