    ...
    @endphp
    <!-- ========= Start Footer ========= -->
    <footer class="footer-12 pt-60 bg-cover bg-img"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 col-lg-6 col-sm-6">
                            ...
                            <div class="footer-widget mb-30" data-aos="fade-up" data-aos-delay="150">
                                <h5 class="mb-24 title fw-medium body-font">
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-12">
                            <div class="footer-widget mb-30" data-aos="fade-up" data-aos-delay="300">
                                <h5 class="mb-24 fw-medium title body-font">
                                    {{ $keywords['Subscribe_Here'] ?? __('Subscribe Here') }}</h5>
                                <p class="fw-medium mb-20">
                                    {{ $keywords['Stay_update_with_us_and_get_offer!'] ?? 'Stay update with us and get offer!' }}
                                </p>
                                    ...
                                    <form id="footerSubscribe" action="{{ route('front.subscribe') }}" method="post"
                                        ...
                                        <div class="subscribe-group-btn subscribe">
                                            <input type="email" name="email"
                                                placeholder="{{ $keywords['Enter_Your_Email'] ?? 'Enter Your Email' }}"
                                                required>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright-content">
                                <div class="fw-medium text-center mb-0">
