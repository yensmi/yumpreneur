   ...
   <section class="featured-section pt-lg-70 pt-60 pb-20 bg-img bg-cover">
       <div class="bg-image">
           <img src="{{ $userBe->special_section_bg_image ? Uploader::getImageUrl(Constant::WEBSITE_IMAGE, $userBe->special_section_bg_image, $userBs) : '' }}"
               alt="image">
       </div>
       <div class="container">
           <div class="row">
