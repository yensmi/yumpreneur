...
<section class="pricing-section pt-lg-90 pt-60 pb-40 bg-cover bg-img"
    data-bg-image="{{ !empty($affordable_deals->background_image) ? Uploader::getImageUrl(Constant::WEBSITE_IMAGE, $affordable_deals->background_image, $userBs) : asset('assets/admin/img/noimage.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
