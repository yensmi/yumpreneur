                                    ...
                                    @foreach ($templates as $template)
                                        <tr>
                                            <td class="text-capitalize">
                                                ...
                                                @elseif ($template->mail_type == 'order_pickup')
                                                ...
                                                @else
                                                    {{str_replace("_", " ", $template->mail_type)}}
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-warning" href="{{route('user.email.editTemplate', $template->id)}}"><i class="far fa-edit"></i> Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
