...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form class="" action="{{route('user.pwa.update')}}" method="post" enctype="multipart/form-data">
          @csrf
                ...
                <div class="row">
                  <div class="col-xl-4">
                    <div class="form-group">
                      ...
                      <div class="col-md-12 showImage mb-3">
                        @if(in_array('PWA Installability',$packagePermissions))
                        <img src="{{ asset(!empty($pwa['icons'][0]['src']) ? Uploader::getImageUrl(Constant::WEBSITE_PWA_IMAGE, $pwa['icons'][0]['src'], $userBs) : '') }}" >
                        @else
                        <img src="{{ asset(!empty($pwa['icons'][0]['src']) ? 'assets/pwa/'.$pwa['icons'][0]['src'] : '') }}" alt="..." class="img-fluid">
                        @endif
                  ...
                  <div class="col-xl-4">
                    <div class="form-group">
                      ...
                      <div class="col-md-12 showImage mb-3">
                        @if(in_array('PWA Installability',$packagePermissions))
                        <img src="{{ asset(!empty($pwa['icons'][1]['src']) ? Uploader::getImageUrl(Constant::WEBSITE_PWA_IMAGE, $pwa['icons'][1]['src'], $userBs) : '') }}" >
                        @else 
                        <img src="{{asset(!empty($pwa['icons'][1]['src']) ? 'assets/pwa/'.$pwa['icons'][1]['src'] : '') }}" alt="..." class="img-fluid">
                        @endif
                  ...
                  <div class="col-xl-4">
                    <div class="form-group">
                      ...
                      <div class="col-md-12 showImage mb-3">
                        ...
                        <img src="{{ asset(!empty($pwa['icons'][2]['src']) ? Uploader::getImageUrl(Constant::WEBSITE_PWA_IMAGE, $pwa['icons'][2]['src'], $userBs) : '') }}" >
                        @else

                        <img src="{{ asset(!empty($pwa['icons'][2]['src']) ? 'assets/pwa/'.$pwa['icons'][2]['src'] : '') }}" alt="..." class="img-fluid">
