                    ...
                    <div class="card-body pt-5 pb-5">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                @csrf
                                @if ($userBs->theme != 'seabbq' && $userBs->theme != 'desifoodie' && $userBs->theme != 'desices')
                                ...
                                @endif
                                @if ($userBs->theme == 'desifoodie' || $userBs->theme == 'desices')
                                    <div class="form-group">
                                        <label>Featured Category Section **</label>
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="featured_category_section" value="1"
                                                    class="selectgroup-input"
                                                    {{ $abs->featured_category_section == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Active</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="featured_category_section" value="0"
                                                    class="selectgroup-input"
                                                    {{ $abs->featured_category_section == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Deactive</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <label>Featured Food Section **</label>
                                    @endif
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="menu_section" value="1"
                                                class="selectgroup-input" {{ $abs->menu_section == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">Active</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="menu_section" value="0"
                                                class="selectgroup-input" {{ $abs->menu_section == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">Deactive</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                @if ($userBs->theme == 'seabbq' || $userBs->theme == 'desifoodie' || $userBs->theme == 'desices')
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="banner_section" value="1"
                                                    class="selectgroup-input"
                                                    {{ $abs->banner_section == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Active</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="banner_section" value="0"
                                                    class="selectgroup-input"
                                                    {{ $abs->banner_section == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Deactive</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Affordable Food Section **</label>
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="affordable_section" value="1"
                                                    class="selectgroup-input"
                                                    {{ $abs->affordable_section == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Active</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="affordable_section" value="0"
                                                    class="selectgroup-input"
                                                    {{ $abs->affordable_section == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Deactive</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="special_section" value="1"
                                                class="selectgroup-input"
                                                {{ $abs->special_section == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">Active</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="special_section" value="0"
                                                class="selectgroup-input"
                                                {{ $abs->special_section == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">Deactive</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                @if ($userBs->theme == 'fastfood')
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="team_section" value="1"
                                                    class="selectgroup-input"
                                                    {{ $abs->team_section == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Active</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="team_section" value="0"
                                                    class="selectgroup-input"
                                                    {{ $abs->team_section == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Deactive</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                @if ($userBs->theme == 'fastfood')
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="table_section" value="1"
                                                    class="selectgroup-input"
                                                    {{ $abs->table_section == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Active</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="table_section" value="0"
                                                    class="selectgroup-input"
                                                    {{ $abs->table_section == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Deactive</span>
                                            </label>
                                        </div>
                                    </div>
