        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    ...
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('user.faq.bulk.delete')}}"><i class="flaticon-interface-5"></i> Delete</button>
                </div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                      @foreach ($faqs as $key => $faq)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm my-2 editbtn" href="#editModal" data-toggle="modal" data-faq_id="{{$faq->id}}" data-question="{{$faq->question}}" data-answer="{{$faq->answer}}" data-serial_number="{{$faq->serial_number}}">
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                              </span>
                              
                            </a>
                            <form class="deleteform d-inline-block" action="{{route('user.faq.delete')}}" method="post">
                              @csrf
