...
@section('content')
    <div class="page-header">
        <h4 class="page-title">Useful Links</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">Useful Links</div>
                        </div>
                        <div class="col-lg-3">
                            @if (!empty($userLangs))
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal"
                               data-target="#createModal"><i class="fas fa-plus"></i> Add Useful Link</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary my-2 btn-sm editbtn" href="#editModal"
                                                       ...
                                                       data-name="{{$aulink->name}}" data-url="{{$aulink->url}}">
                                                    ...
                                                    <form class="deleteform d-inline-block"
                                                          action="{{route('user.ulink.delete')}}" method="post">
                                                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Useful Link</h5>
