    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{route('user.jcategory.index')}}">
              ...
              <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data" action="{{route('admin.scategory.uploadUpdate', $scategory->id)}}" method="POST">
                ...
                <div class="form-row px-2">
                  ...
                  <div class="col-md-12 d-md-block d-sm-none mb-3">
                    <img src="{{asset('assets/front/img/service_category_icons/'.$scategory->image)}}" alt="..." class="img-thumbnail" width="200">
                  </div>
                  <div class="col-sm-12">
