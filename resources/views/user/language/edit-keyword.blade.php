...
@if (empty($la) && $userBe->default_language_direction == 'rtl')
@section('styles')
<style>
    form input {
        direction: rtl;
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-12">
              <form method="post" action="{{ route('user.language.updateKeyword', $la->id) }}" id="ajaxForm">
                  {{ csrf_field() }}
                  <div class="row">
          ...
          <div class="form">
            <div class="form-group from-show-notify row">
              <div class="col-12 text-center">
                <button id="submitBtn" type="button" class="btn btn-success">{{__('Update')}}</button>
              </div>
            </div>
          </div>
        </div>
