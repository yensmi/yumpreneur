                    ...
                    <tbody>
                      @foreach ($languages as $key => $language)
                        <tr>
                          ...
                          <td>
                           <a class="btn btn-secondary btn-sm my-2" href="{{route('user.language.editKeyword', $language->id)}}">
                           <span class="btn-label">
                             <i class="fas fa-edit"></i>
                           </span>
                           {{__('Keyword')}}
                           </a>
                            <a class="btn btn-secondary btn-sm my-2" href="{{route('user.language.edit', $language->id)}}">
                            <span class="btn-label">
                              <i class="fas fa-edit"></i>
                            </span>
                            {{__('Edit')}}
