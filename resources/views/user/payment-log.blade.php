                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p><strong>{{__('Start Date')}}: </strong>
                                                        @if (\Illuminate\Support\Carbon::parse($membership->start_date)->tz($userBe->timezone)->format('Y') == '9999')
                                                            <span class="badge badge-danger">{{__('Never Activated')}}</span>
                                                        @else
                                                            {{\Illuminate\Support\Carbon::parse($membership->start_date)->tz($userBe->timezone)->format('M-d-Y')}}
                                                        @endif
                                                    </p>
                                                    <p><strong>{{__('Expire Date')}}: </strong>
                                                        ...
                                                        @else
                                                            @if ($membership->modified == 1)
                                                                {{\Illuminate\Support\Carbon::parse($membership->expire_date)->tz($userBe->timezone)->addDay()->format('M-d-Y')}}
                                                                <span class="badge badge-primary btn-xs">{{__('modified by Admin')}}</span>
                                                            @else
                                                                {{$membership->package->term == 'lifetime' ? 'Lifetime' : \Illuminate\Support\Carbon::parse($membership->expire_date)->tz($userBe->timezone)->format('M-d-Y')}}
                                                            @endif
                                                        @endif
                                                    </p>
                                                    <p>
