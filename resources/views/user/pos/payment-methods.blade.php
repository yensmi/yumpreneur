                      ...
                      @foreach ($pmethods as $key => $pmethod)
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteform d-inline-block" action="{{route('user.pos.pmethod.delete')}}" method="post">
                              @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{route('user.pos.pmethod.store')}}" method="POST">
            @csrf
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('user.pos.pmethod.update')}}" method="POST">
            @csrf
