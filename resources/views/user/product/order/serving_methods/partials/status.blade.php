    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('user.product.servingMethodStatus')}}" method="POST" id="servingMethodStatus{{$sm->id}}">
                @csrf
                ...
                @endif
                @if(!empty($packagePermissions) && in_array('Online Order',$packagePermissions) && in_array('QR Menu',$packagePermissions))
                <div class="form-group">
