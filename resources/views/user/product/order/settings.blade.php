            ...
            <div class="card-body pt-5 pb-5">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        <form action="{{route('user.reset.token')}}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label>Token No. Restarts From **</label>
                                <div class="row">
                                    <div class="col-9">
                                        <input type="number" class="form-control" name="token_no" placeholder="Enter Toke no from it will start" value="{{$userBs->token_no_start}}" required>
                                    </div>
                                    <div class="col-3">
                        ...
                        @endif
                        <form id="settingsForm" action="{{route('user.order.update.settings')}}" method="post">
                            @csrf
                            <div class="row">
                                 @if(!empty($packagePermissions) && in_array('Postal Code Based Delivery Charge',$packagePermissions))
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Postal Code Based Delivery **</label>
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="postal_code" value="1" class="selectgroup-input" {{$userBs->postal_code == 1 ? 'checked' : ''}}>
                                                <span class="selectgroup-button">Enable</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="postal_code" value="0" class="selectgroup-input" {{$userBs->postal_code == 0 ? 'checked' : ''}}>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="delivery_date_time_status" value="1" class="selectgroup-input" {{$userBe->delivery_date_time_status == 1 ? 'checked' : ''}}>
                                                <span class="selectgroup-button">Enable</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="delivery_date_time_status" value="0" class="selectgroup-input" {{$userBe->delivery_date_time_status == 0 ? 'checked' : ''}}>
                                                <span class="selectgroup-button">Disable</span>
                                            </label>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="delivery_date_time_required" value="1" class="selectgroup-input" {{$userBe->delivery_date_time_required == 1 ? 'checked' : ''}}>
                                                <span class="selectgroup-button">Required</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="delivery_date_time_required" value="0" class="selectgroup-input" {{$userBe->delivery_date_time_required == 0 ? 'checked' : ''}}>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <p class="text-warning mb-0 d-inline-block">If you want to enable any whatsapp notification, then you have to setup twilio credentials from </p> <a class="text-primary text-decoration-none" target="_blank" href="{{route('user.plugins')}}">Settings > Plugins</a>
