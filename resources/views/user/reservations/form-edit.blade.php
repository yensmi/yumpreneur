          ...
          <div class="card-title">
              <div class="row">
                  ...
                  <div class="col-lg-6 text-right">
                    <a class="btn btn-primary" href="{{route('user.reservation.form') . '?language=' . request()->input('language')}}">Back</a>
                  </div>
              </div>
          </div>
        </div>
        ...
        <div class="card-body">
            <div class="row" id="app">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form id="ajaxForm" action="{{route('user.reservation.inputUpdate')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
...
<script>
  ...
  var reservationRoute = "{{route('user.reservation.options', $input->id)}}";
</script>
   <script src="{{ asset('assets/tenant/js/vue__edit_blade.js') }}"></script>
@endsection
