...
@section('content')
                    ...
                    <tbody>
                      @foreach ($roles as $key => $role)
                        <tr>
                          ...
                          <td>{{$role->name}}</td>
                          <td>
                            <a class="btn btn-info btn-sm editbtn" href="{{route('user.role.permissions.manage', $role->id)}}">
                          ...
                          <td>
                            <a class="btn btn-secondary my-2 btn-sm editbtn" href="#editModal" data-toggle="modal" data-role_id="{{$role->id}}" data-name="{{$role->name}}">
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                              </span>
  ...
  @includeif('user.role.create')

  @includeif('user.role.edit')
