...
@section('content')
    ...
    <div class="page-header">
        ...
        <a href="{{route('user.table.index')}}" class="btn btn-primary"
                ...
                <div class="card-body">
                    ...
                    <form id="qrGeneratorForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control jscolor" name="color" value="{{$table->color}}"
                                   onchange="generateQr()">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control p-0 range-slider" name="size" type="range" min="200" max="350"
                                   value="{{$table->size}}" onchange="generateQr()">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control p-0 range-slider" name="margin" type="range" min="0" max="5"
                                   value="{{$table->margin}}" onchange="generateQr()">
                        ...
                        <div class="form-group">
                            ...
                            <select name="eye_style" class="form-control" onchange="generateQr()">
                                ...
                                <option value="square" {{$table->eye_style == 'square' ? 'selected' : ''}}>Square
                                </option>

                                <option value="circle" {{$table->eye_style == 'circle' ? 'selected' : ''}}>Circle
                                </option>
                        ...
                        <div id="type-image" class="types">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 showImage mb-3">
                                    <img
                                        src="{{ $table->image ? Uploader::getImageUrl(Constant::WEBSITE_TABLE_IMAGE,$table->image,$userBs) : asset('assets/admin/img/noimage.jpg')}}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control p-0 range-slider" name="image_size" type="range" min="1"
                                       max="20" value="{{$table->image_size}}" onchange="generateQr()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control p-0 range-slider" name="image_x" type="range" min="0"
                                       max="100" value="{{$table->image_x}}" onchange="generateQr()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control p-0 range-slider" name="image_y" type="range" min="0"
                                       max="100" value="{{$table->image_y}}" onchange="generateQr()">
                        ...
                        <div id="type-text" class="types">
                            <div class="form-group">
                                ...
                                <input type="text" name="text" value="{{$table->text}}" class="form-control"
                                       onchange="generateQr()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="text_color" value="{{$table->text_color}}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control p-0 range-slider" name="text_size" type="range" min="1"
                                       max="15" value="{{$table->text_size}}" onchange="generateQr()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control p-0 range-slider" name="text_x" type="range" min="0"
                                       max="100" value="{{$table->text_x}}" onchange="generateQr()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control p-0 range-slider" name="text_y" type="range" min="0"
                                       max="100" value="{{$table->text_y}}" onchange="generateQr()">
            ...
            <div class="card bg-white">
                ...
                <div class="card-body text-center py-5">
                    ...
                    <div class="p-3 border-rounded d-inline-block border" style="background-color: #f8f9fa!important;">
                        <img id="preview" src="{{Uploader::getImageUrl(Constant::WEBSITE_TABLE_IMAGE,$table->qr_image,$userBs)}}" alt="">

                    </div>

                </div>
                <div class="card-footer text-center" style="border-top: 1px solid #ebecec!important;">
                    <form id="formId" action="{{ route('user.table.qr.download', ['name' => $table->qr_image]) }}" method="GET">
...
@section('scripts')
    <script type="text/javascript">
        "use strict";
        var qrGenUrl = "{{route('user.table.qr.generate')}}";
        var qrDownloadUrl = "{{route('user.table.qr.download')}}";
    </script>
